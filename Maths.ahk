...
;msgbox % f:=SM_Number2base("10485761048", 16) ;base 32
;msgbox % SM_Base2Number(t, 2) "`n" SM_Base2Number(f, 16) "`n" SM_Number2Base("83186701322",32)
;return
...
;Check for functions --
	if RegExMatch(A_LoopField, "iU)^[a-z0-9_]+\(.*\)$") 				;Ungreedy ensures throwing cases like sin(45)^sin(95)
	{
		...
		loop, parse, ffeed,`,
		{
			StringReplace,feed,A_loopfield,",,All             ;; " <- to clear the quote for color coding
